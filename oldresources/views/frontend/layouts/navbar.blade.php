        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="#pdf" class="text-gray-700 hover:text-purple-600 font-medium transition">PDF Tools</a>
                    <a href="#image" class="text-gray-700 hover:text-purple-600 font-medium transition">Image Tools</a>
                    <a href="#email" class="text-gray-700 hover:text-purple-600 font-medium transition">Bulk Email</a>
                    <a href="#features" class="text-gray-700 hover:text-purple-600 font-medium transition">Features</a>
                </div>
                <button class="bg-[#6a6bcf] text-white px-6 py-2 rounded-full hover:bg-purple-700 transition font-semibold">
                    Get Started
                </button>
            </div>
        </div>
