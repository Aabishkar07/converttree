    ...
    <section id="home" class="text-white py-10 relative overflow-hidden" style="background: linear-gradient(135deg, #6a6bcf 0%, #5a5bbf 50%, #4a4baf 100%);">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <h1 class="text-4xl md:text-6xl font-bold mb-6 text-white leading-tight">
                 File Converter & Bulk Emailing
            </h1>
            <p class="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto">
                Convert images, PDFs, documents & send bulk emails with professional quality all formats supported
            </p>
            ...
            <div class="flex justify-center gap-4 flex-wrap">
                <a href="https://imageconverter-pearl.vercel.app/" target="_blank" class="bg-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-1 shadow-lg" style="color: #6a6bcf;">
