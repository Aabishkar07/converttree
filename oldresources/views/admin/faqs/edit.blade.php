                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-gray-50 rounded-lg p-6 space-y-6">
                                ...
                                <div class="bg-white rounded-lg p-4 border border-gray-200">
                                    <h4 class="text-sm font-medium text-gray-900 mb-2">FAQ Information</h4>
                                    <div class="text-xs text-gray-600 space-y-1">
                                        ...
                                        <p><strong>FAQ ID:</strong> {{ $faq->id }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white rounded-lg p-4 border border-gray-200">
                                    ...
                                    <div class="text-xs text-gray-600 space-y-1">
                                        <p><strong>Question:</strong> <span id="preview-question">{{ $faq->question }}</span></p>
                                        <p><strong>Answer:</strong> <span id="preview-answer">{{ Str::limit($faq->answer, 50) }}</span></p>
                                        <p><strong>Order:</strong> <span id="preview-order">{{ $faq->order }}</span></p>
                                        <p><strong>Status:</strong> <span id="preview-status" class="{{ $faq->is_active ? 'text-green-600' : 'text-red-600' }}">{{ $faq->is_active ? 'Active' : 'Inactive' }}</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
