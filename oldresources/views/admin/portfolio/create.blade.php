...
@section('page_title', 'Add Portfolio')
...
@section('body')
    <div class="flex items-center gap-x-2 px-4">
        ...
        <div class="text-lg font-bold">Add Portfolio</div>
    </div>
                ...
                <div class="flex flex-col">
                    <div>
                        ...
                        <div>
                            <input
                                ...
                                name="title" placeholder="Type  name here" type="text"
                                value="{{ old('title') }}" />
                            @error('title')
                    ...
                    <div>
                        ...
                        <div>
                            <input
                                class="text-xs focus:outline-none focus:ring-blue-500 focus:border-blue-500 border border-gray-300 p-2 rounded mt-1 hover:border-blue-500 w-full"
                                name="banner_order" placeholder="Type portfolio order here" type="text"
  ...
  <div>
                        ...
                        <div>
                            <input
                                class="text-xs focus:outline-none focus:ring-blue-500 focus:border-blue-500 border border-gray-300 p-2 rounded mt-1 hover:border-blue-500 w-full"
                                name="link" placeholder="Type link here" type="text"
                                value="{{ old('link') }}" />
                            @error('link')
                                <div class="invalid-feedback text-red-400 text-sm" style="display: block;">
                                    * {{ $message }}
                    ...
                    <div class="flex justify-end">
                        <button
                            class="border mt-5 bg-[#05034b] border-[#05034b] px-4 py-1 rounded-md mr-2 text-white hover:bg-white transition duration-500 ease-in-out hover:text-[#05034b]">
                            Submit
                        </button>
                    </div>
                </div>
