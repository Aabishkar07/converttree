...
@section('body')
    ...
    <div class="flex items-center">
        <div class="flex-1">
            <h2 class="w-full text-2xl font-bold text-secondary ">Our Products</h2>
        </div>
        <div class="text-right "> <a href="{{ route('admin.product.create') }} "
                        ...
                        @foreach ($products as $key => $product)
                            <tbody class="bg-white divide-y divide-gray-200 ">
                                <tr>
                                    ...
                                    <td class="px-5 py-3 ">
                                        <p class="text-gray-900 ">{{ $product->servicename->title }}</p>
                                    </td>
